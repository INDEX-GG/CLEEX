...
use App\SberbankAcquiring\Exception\ActionException;
use App\SberbankAcquiring\Exception\BadResponseException;
...
class Client
{
    ...
    public function getLastOrdersForMerchants(\DateTimeInterface $from, \DateTimeInterface $to = null, array $data = []): array
    {
        ...
        $data['transactionStates'] = array_map('App\SberbankAcquiring\OrderStatus::statusToString', $data['transactionStates']);
