...
<header>
	...
	<div class="menu">
		<ul>
			...
			<li class="menu-item hidden"><a href="https://codeigniter4.github.io/userguide/" target="_blank">Документация</a>
			</li>
			<li class="menu-item hidden"><a href="https://forum.codeigniter.com/" target="_blank">Сообщество</a></li>
			<li class="menu-item hidden"><a
					href="https://github.com/codeigniter4/CodeIgniter4/blob/master/CONTRIBUTING.md" target="_blank">Сотрудничать</a>
			</li>
		</ul>
	</div>
	...
	<div class="heroe">
		...
		<h1>Добро пожаловать в CodeIgniter <?= CodeIgniter\CodeIgniter::CI_VERSION ?></h1>

		<h2>Небольшой фреймворк с мощными функциями</h2>
...
<section>
	...
	<h1>Об этой странице</h1>

	<p>Страница, на которую вы смотрите, генерируется динамически CodeIgniter.</p>
...
<div class="further">
	...
	<section>
		...
		<p>Руководство пользователя содержит введение, учебник, ряд "how to" руководства, а 
		затем справочная документация для компонентов, входящих в состав framework. Проверьте <a href="https://codeigniter4.github.io/userguide"
			target="_blank">Руководство пользователя</a> !</p>
		...
		<p>CodeIgniter это проект с открытым исходным кодом, разработанный открытым сообществом, где члены сообщества могут собираться и 
		обмениваться идеями. Просмотр всех направлений на <a href="https://forum.codeigniter.com/"
			 target="_blank">CodeIgniter's форум</a>, or <a href="https://codeigniterchat.slack.com/"
			 target="_blank">Чат на Slack</a> !</p>
		...
		<p>CodeIgniter является проектом, управляемым сообществом, и принимает новый код и документацию от сообщества.
			 <a href="https://codeigniter.com/en/contribute" target="_blank">
			 присоединяйтесь к нам</a> ?</p>
...
<footer>
	<div class="environment">
		...
		<p>Время загрузки страницы - {elapsed_time} секунд</p>
	...
	<div class="copyrights">
		...
		<p>&copy; <?= date('Y') ?> CodeIgniter Foundation. CodeIgniter - это проект с открытым исходным
            кодом, выпущенный под лицензией MIT open source license.</p>
