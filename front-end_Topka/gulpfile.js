let project_folder = "../build/public/topkatpl";
...
let path = {
    ...
    src: {
        html: source_folder + "/topka.html",
        pages: [source_folder + "/**/*.html", "!" + source_folder + "/**/_*.html", "!" + source_folder + "/**/topka.html" ],
